...
<body>
                                	...
                                	<c:forEach items="${categories }" var = "cat">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	...
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalCategorie${cat.getIdCategorie() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalCategorie${cat.getIdCategorie() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script src="<%=request.getContextPath() %>/resources/javascript/categorie.js"></script>
</body>
